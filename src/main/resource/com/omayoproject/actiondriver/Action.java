package com.omayoproject.actiondriver;
...
public class Action extends BasePage {
	...
	public void click(WebElement ele) {
		try {
			...
			System.out.println("Not Successfully click element"+": "+e.getMessage());
	...
	public String getText(WebElement ele) {
		try {
			...
			System.out.println("Not Successfully get Text"+": "+e.getMessage());
			return null;
		}
	}
	...
	public boolean sendText(WebElement ele, String text) {
		...
		//	ele.clear();
			...
			System.out.println("Not Successfully entered text"+": "+e.getMessage());
			return false;
		}
	...
	public boolean findElement(WebElement ele) {
		try {
			...
			System.out.println("Not Successfully Found element"+": "+e.getMessage());
			return false;
	...
	public boolean isSelected(WebElement ele) {
		try {
			...
			System.out.println("The element not Selected"+": "+e.getMessage());
			return false;
		}
	...
	public boolean selectByValueWithDiv(String value, WebElement ele) {
		try {
			...
			System.out.println("Not Selected value from the DropDown"+": "+e.getMessage());
			return false;
		}
	}
	...
	public boolean selectByIndex(WebElement ele, int index) {
		try {
			...
			System.out.println("Option Not selected by Index"+": "+e.getMessage());
			return false;
		}
	}
	...
	public boolean selectByValue(WebElement ele, String value) {
		try {
			...
			System.out.println("Option Not selected by Value"+": "+e.getMessage());
			return false;
		}
	...
	public boolean switchToFrameById(WebDriver driver, String idValue) {
		try {
			...
			e.printStackTrace();
			System.out.println("Frame with Id \"" + idValue + "\" is not selected"+": "+e.getMessage());
			return false;
		}
	}
	...
	public boolean switchToFrameByName(WebDriver driver, String nameValue) {
		try {
			...
			System.out.println("Frame with Name \"" + nameValue + "\" is not selected"+": "+e.getMessage());
			return false;
		}
	}
	...
	public boolean switchToNewWindow(WebDriver driver) {
		try {
			...
			System.out.println("The Window with title is not selected"+": "+e.getMessage());
			return false;
		}
	}
	...
	public boolean AlertAccept(WebDriver driver) {
		try {
			...
			System.out.println("There was no alert to handle"+": "+ex.getMessage());
			return false;
		}
	}
	...
	public boolean AlertText(WebDriver driver, String text, Duration timeOut) {
		try {
			...
			System.out.println("Timeout: No alert to handle"+": "+ex.getMessage());
		} catch (NoAlertPresentException ex) {
			System.out.println("No alert to handle"+": "+ex.getMessage());
		}
	...
	public boolean selectByVisibleText(String visibletext, WebElement ele) {
		try {
			...
			System.out.println("Option not selected by VisibleText"+": "+e.getMessage());
			return false;
		}
	}
	...
	public boolean mouseHoverByJavaScript(WebElement ele) {
		try {
			...
			System.out.println("MouseOver Action is not performed"+": "+e.getMessage());
			return false;
		}
	}
	...
	public void mouseOverElement(WebDriver driver, WebElement element) {
		try {
			...
			e.printStackTrace();
			System.out.println("MouseOver action is not performed on"+": "+e.getMessage());
		}
	}
	...
	public boolean dragAndDrop(WebDriver driver, WebElement source, int x, int y) {
		try {
			...
			System.out.println("Draggable action is not performed on \"" + source + "\""+": "+e.getMessage());
			return false;
		}
	}
	...
	public boolean dragAndDrop(WebDriver driver, WebElement source, WebElement target) {
		try {
			...
			System.out.println("DragAndDrop Action is not performed"+": "+e.getMessage());
			return false;
		}
	}
	...
	public boolean slider(WebDriver driver, WebElement ele, int x, int y) {
		try {
			...
			System.out.println("Slider Action is not performed"+": "+e.getMessage());
			return false;
		}
	}
	...
	public boolean rightClick(WebDriver driver, WebElement ele) {
		try {
			...
			System.out.println("RightClick Action is not performed"+": "+e.getMessage());
			return false;
		}
	}
